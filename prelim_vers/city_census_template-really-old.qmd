...
dplyr::arrange(year) |>
dplyr::mutate(
  estimate      = base::paste0("$", base::format(base::round(estimate, 0), big.mark = ",")),
  estimate_real = base::paste0("$", base::format(base::round(estimate_real, 0), big.mark = ","))
) |>
dplyr::select(
  Year     = year,
  Nominal  = estimate,
...
subtitle  = "PEP Annual Population Estimates",
y_label   = "Population"
)
```
