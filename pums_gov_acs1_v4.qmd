...
subtitle: "Local, State, Federal for Schertz and Surrounds"
authors: 
...
# =============================================================================
# GET PUMS DATA - with type standardization
# =============================================================================

get_pums_data <- function(state, puma_codes, year, min_age, survey, cache_dir) {
  key <- cache_key("pums_v4", state, puma_codes, year, min_age, survey)
  path <- cache_path(cache_dir, key)
  cached <- cache_read(path)
  if (!is.null(cached)) {
  ...
  # ==========================================================================
  # STANDARDIZE COLUMN TYPES - critical for binding across years
  # ==========================================================================
  ...
  # Standardize replicate weight columns
  pwgtp_cols <- grep("^PWGTP\\d+$", names(raw), value = TRUE)
  for (col in pwgtp_cols) {
...
# Select only the columns we need (avoids any extra columns causing issues)
