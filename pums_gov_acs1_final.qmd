...
# Fetch data for all years (cached after first run)
...
# Select only needed columns before binding
...
as.data.frame.matrix(table(gov_employees$gov_level, gov_employees$year)) |>
